...
- YAML issue templates (bug report, false positive report)
- GitHub Sponsors funding configuration
- OpenSSF Scorecard badge in README

### Removed
- config.json from repository root (user config belongs in ~/.config)
- Legacy markdown bug report template (replaced by YAML form)
...
[Unreleased]: https://github.com/3062-in-zamud/ai-multi-review/compare/v0.3.0...HEAD
[0.3.0]: https://github.com/3062-in-zamud/ai-multi-review/compare/v0.2.0...v0.3.0
